...
from gi.repository import Gtk, Gdk, GdkPixbuf, GObject, WebKit, Pango
#import pygtk
#pyGtk.require('2.0')
#import gobject
...
class Naufrago:
 ...
 def toggle_importante(self, cell, path, model):
  ...
  if model[path][1] == True:
   self.eb.modify_bg(Gtk.StateType.NORMAL, Gdk.color_parse("pink")) # Entry title bg glow
   ...
   self.eb.modify_bg(Gtk.StateType.NORMAL, Gdk.color_parse("#EDECEB")) # Entry title bg normalize
   if model[path][3] == 'bold':
    if no_leidos is not None:
     no_leidos = int(no_leidos) - 1
     if no_leidos == 0:
 ...
 def list_row_selection(self, event):
  ...
  if(iter is not None): # Hay alguna fila de la lista seleccionada
   ...
   if flag_importante:
    self.eb.modify_bg(Gtk.StateType.NORMAL, Gdk.color_parse("pink"))
   else:
    self.eb.modify_bg(Gtk.StateType.NORMAL, Gdk.color_parse("#EDECEB"))
   ...
   self.headerlink.set_ellipsize(Pango.EllipsizeMode.END)
   self.eb.show()
 ...
 def help_about(self, action):
  ...
  about.set_logo(GdkPixbuf.Pixbuf.new_from_file(media_path + 'Viking_Longship.svg'))
  about.run()
  about.destroy()
 ...
 def create_ui(self, window):
  ...
  pixbuf = GdkPixbuf.Pixbuf.new_from_file(media_path + 'SRD_RSS_Logo_mini.png')
  iconset = Gtk.IconSet.new_from_pixbuf(pixbuf)
  factory.add('rss-image', iconset)
  factory.add_default()

  factory = Gtk.IconFactory()
  pixbuf = GdkPixbuf.Pixbuf.new_from_file(media_path + 'cross_out.png')
  iconset = Gtk.IconSet.new_from_pixbuf(pixbuf)
  ...
  ag = Gtk.ActionGroup.new('WindowActions')
  actions = [
 ...
 def create_main_window(self):
  ...
  ###widget = self.ui.get_widget('/Menubar', True, True, 0)
  widget = self.ui.get_widget('/Menubar')
  ###self.vbox.pack_start(widget, expand=False)
  self.vbox.pack_start(widget, False, True, True)
  ###self.vbox.pack_start(self.ui.get_widget('/Menubar', True, True, 0), expand=False)
  ...
  print 'I personally stopped porting to pygi HERE...'
  #########################################################
  #########################################################
  # Waiting for pygobject 2.26 package to enter Debian... #
  #########################################################
  #########################################################
  ...
  self.scrolled_window1.set_policy(Gtk.PolicyType.AUTOMATIC, Gtk.PolicyType.AUTOMATIC)
  ...
  self.liststore = Gtk.ListStore.newv([str, bool, str, str, int])
  ...
  self.image.set_from_stock(Gtk.STOCK_MEDIA_RECORD, Gtk.IconSize.MENU) # Record icon
  ...
  self.scrolled_window3.set_policy(Gtk.PolicyType.AUTOMATIC, Gtk.PolicyType.AUTOMATIC)
  ...
  self.image_zoom.set_from_stock(Gtk.STOCK_ZOOM_FIT, Gtk.IconSize.MENU) # Record icon
  ...
  self.headerlink = Gtk.Label(label="")
  ...
  self.eb.window.set_cursor(Gdk.Cursor(Gdk.HAND2))
 ...
 def create_trayicon(self):
  ...
  icon = update_item.render_icon(Gtk.STOCK_REFRESH, Gtk.IconSize.BUTTON)
  update_item.set_image(Gtk.image_new_from_pixbuf(icon))
  quit_item = Gtk.ImageMenuItem(_("Quit"))
  icon = quit_item.render_icon(Gtk.STOCK_QUIT, Gtk.IconSize.BUTTON)
 ...
 def add_feed(self, data=None):
  ...
  labelName = Gtk.Label(label=_('Name '))

  new = False
  if((data is not None) and (type(data) is not Gtk.Action)): #  Modo edición I
   labelURL = Gtk.Label(label='URL       ')
   cursor = self.conn.cursor()
 ...
 def preferences(self, data=None):
  ...
  align.add(vbox2)
  notebook.append_page(align, Gtk.Label(label=_("Start")))

  vbox3 = Gtk.VBox(homogeneous=True)
  align2 = Gtk.Alignment()
  align2.set_padding(10, 0, 15, 0)
  hbox = Gtk.HBox()
  label = Gtk.Label(label=_("Number of feed entries"))
  ...
  hbox2 = Gtk.HBox()
  label2 = Gtk.Label(label=_("Update every (hours)"))
  ...
  align2.add(vbox3)
  notebook.append_page(align2, Gtk.Label(label=_("Feeds & articles")))
  ...
  hbox3 = Gtk.HBox()
  label3 = Gtk.Label(label=_("Toolbar mode"))
  ...
  align3.add(vbox4)
  notebook.append_page(align3, Gtk.Label(label=_("Interface")))
 ...
 def treeview_setup_dnd(self, treeview):
  ...
  treeview.enable_model_drag_source(Gdk.BUTTON1_MASK, target_entries, Gdk.ACTION_MOVE)
  # Params: 1st mouse button, target_entries (ver arriba), type of action to do
  # Drag end operation (destination)
  treeview.enable_model_drag_dest(target_entries, Gdk.ACTION_MOVE)
 ...
 def tree_button_press_event(self, treeview, event):
  ...
  if event.button == 3:
   ...
   if pthinfo is not None:
    ...
    icon = toggle_todos_leido_item.render_icon(Gtk.STOCK_SELECT_ALL, Gtk.IconSize.BUTTON)
    ...
    if (id != 9998) and (id != 9999):
     ...
     icon = edit_item.render_icon(Gtk.STOCK_EDIT, Gtk.IconSize.BUTTON)
     ...
     icon = delete_item.render_icon(Gtk.STOCK_CLOSE, Gtk.IconSize.BUTTON)
     ...
     icon = new_feed_item.render_icon(Gtk.STOCK_FILE, Gtk.IconSize.BUTTON)
     new_feed_item.set_image(Gtk.image_new_from_pixbuf(icon))
     new_category_item = Gtk.ImageMenuItem(_("New category"))
     icon = new_category_item.render_icon(Gtk.STOCK_DIRECTORY, Gtk.IconSize.BUTTON)
 ...
 def tree2_button_press_event(self, treeview, event):
  ...
  if event.button == 3:
   ...
   if pthinfo is not None:
    ...
    icon = copiar_portapapeles_item.render_icon(Gtk.STOCK_PASTE, Gtk.IconSize.BUTTON)
    ...
    icon = toggle_leido_item.render_icon(Gtk.STOCK_INDEX, Gtk.IconSize.BUTTON)
 ...
 def add_icon_to_factory(self, filename, id_feed=None):
  ...
  if filename == None:
   ...
   factory = Gtk.IconFactory()
   pixbuf = GdkPixbuf.Pixbuf.new_from_file(media_path + 'blue_folder.png')
   iconset = Gtk.IconSet.new_from_pixbuf(pixbuf)
